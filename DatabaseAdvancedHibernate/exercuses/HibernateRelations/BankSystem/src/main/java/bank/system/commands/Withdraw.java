...
public class Withdraw extends Command {
    ...
    public Withdraw(boolean isUserLoggedIn, UserService userService, AccountService accountService, User loggedUser) {
    ...
    public String execute(String... params) {
        ...
        BigDecimal balance = operation.withdrawMoney(new BigDecimal(params[1]));
